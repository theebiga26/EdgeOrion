          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xs font-bold text-primary uppercase tracking-widest">Technical Showcase</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold leading-tight mb-2 text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">
                ...
                SDK & Technology Integration.
                <span className="text-primary/50 font-mono font-light ml-2">{'}'}</span>
              </h2>
              <h3 className="text-xl text-white mb-6 font-medium">Built for industry-standard Edge AI frameworks.</h3>
              ...
              <p className="text-textMuted text-sm leading-relaxed mb-8 max-w-md relative">
                ...
                Edge Orion provides native support for powerful edge computing architectures. Seamlessly deploy and optimize your AI models with out-of-the-box compatibility for NVIDIA Jetson, JetPack, and DeepStream.
              </p>
              
              <motion.button 
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-2 bg-gradient-to-r from-secondary to-primary transition-all text-white font-medium rounded-tl-[30px] rounded-br-[30px] rounded-tr-[4px] rounded-bl-[4px] shadow-[0_0_20px_rgba(122,0,230,0.6)] hover:shadow-[0_0_30px_rgba(212,20,255,0.8)]"
              >
                Learn More
              </motion.button>
            </motion.div>
            ...
            >
               ...
               <img src="/web3_tools.png" alt="SDK Integration" className="w-full max-w-md rounded-xl shadow-2xl relative z-10 transition-transform duration-500 group-hover:-translate-y-2" />
            </motion.div>
          </div>
        </div>
      </div>
