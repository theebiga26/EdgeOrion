...
export default function EnterpriseScale() {
  ...
  useEffect(() => {
    ...
    const onInteract = () => {
      ...
      resetTimer = setTimeout(() => { userScrolling = false; }, 2000);
    };
          ...
          <div className="lg:col-span-8 overflow-hidden rounded-2xl relative">
            ...
            >
              ...
              {features.map((feature, index) => (
                <div 
                  key={feature.id}
                  className="ent-card flex-none w-[320px] md:w-[350px] h-[550px] relative rounded-2xl overflow-hidden snap-start group border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.5)] cursor-pointer bg-[#0a0514]"
                  style={{ animationDelay: `${index * 80}ms` }}
                >
                  {/* Full Background Image - SVG with contain layout */}
                  <img 
                    src={feature.image} 
                    alt={feature.title} 
                    className="absolute inset-0 w-full h-full object-contain p-4 transition-transform duration-700 group-hover:scale-105 will-change-transform" 
                    loading="lazy"
                    decoding="async"
                  />
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0a0514] via-[#0a0514]/75 to-transparent opacity-90 group-hover:opacity-100 transition-opacity duration-500"></div>
